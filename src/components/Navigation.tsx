...
const NAV_SECTIONS: NavSection[] = [
  ...
  { href: '/apparel-entry-candidates', label: 'Entry Candidates' },
  {
    ...
    children: [
      ...
      { href: '/competitive-response', label: 'Competitive Response', status: 'beta', description: 'Who reacts when Gymreapers moves - lag, response type, brand agility' },
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/competitive-response', label: 'Competitive Response', status: 'beta', description: 'Who reacts when Gymreapers moves - lag, response type, brand agility' },
      { href: '/gr-sku-tracker', label: 'Apparel SKU Tracker', status: 'beta', description: 'Per-SKU performance for the apparel push - review velocity, sale state, days since launch, peer benchmark' },
      ...
      { href: '/site-ux', label: 'Site UX', status: 'beta', description: 'Weekly PageSpeed + structural signals per brand - performance, nav, features, PDP depth' },
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/usage', label: 'Usage', status: 'beta', description: 'What the team actually uses — anonymous, aggregated' },
