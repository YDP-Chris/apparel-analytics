...
const LANES: Lane[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'VoC Complaints',         href: '/voc-complaints',                status: 'live', description: 'Just shipped. Top complaint themes per brand from review + Reddit mining.',                   updated: '2026-05-16' },
      { title: 'VoC Personas',           href: '/voc-personas',                  status: 'live', description: 'Just shipped. Persona archetypes synthesized from review language.',                          updated: '2026-05-16' },

      { title: 'Apparel SKU performance tracker',                                status: 'queued',  description: 'Track unit-level sell-through for apparel SKUs across competitors.' },
      { title: 'Site UX / store comparison',                                     status: 'queued',  description: 'Side-by-side PDP, cart, and checkout walkthroughs vs peers.' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Weekly digest - apparel-thesis section',          status: 'queued',  description: 'Expand the weekly digest to include an apparel-thesis block alongside the existing core sections.' },
      ...
      { title: 'Own-data integration (Shopify + Klaviyo + CDB)',   status: 'blocked', description: 'Gymreapers internal data. Chris said "once we have built trust" - so this stays parked.' },
    ],
  },
];
